...
SECRET_KEY = 'django-insecure-%q%io8p7zh9c$zr63x3za94grg%g)o+544l+d$p-b+g0%nx54_'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'django',       # Replace 'your_database_name' with the name of your MySQL database
        'USER': 'admin',      # Replace 'your_mysql_username' with your MySQL username
        'PASSWORD': '123',  # Replace 'your_mysql_password' with your MySQL password
